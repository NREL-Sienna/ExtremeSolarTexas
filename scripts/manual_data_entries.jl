...
####################################### Load Time Series ###################################
area_name_number_map = Dict("1" => "FarWest",
                            "2" => "North",
                            "3" => "West",
                            "4" => "Southern",
                            "5" => "NorthCentral",
...
####################################### Wind Time Series ##################################
area_number_wind_map = Dict("1" => "LZ_West",
                            "2" => "LZ_North",
                            "3" => "West_North",
                            "4" => "Houston",
                            "5" => "LZ_North",
...
"QUAIL_RUN_ENERGY1" => ("QUAIL_RUN_ENERGY1_CC1", "QUAIL_RUN_ENERGY1_CC2", "QUAIL_RUN_ENERGY1_CC4"),
"QUAIL_RUN_ENERGY2" => ("QUAIL_RUN_ENERGY2_CC1", "QUAIL_RUN_ENERGY2_CC2", "QUAIL_RUN_ENERGY2_CC4"),
"PARIS_ENERGY_CENTER" => ("PARIS_ENERGY_CENTER_CC1", "PARIS_ENERGY_CENTER_CC2"),
"WICHITA_FALLS_COGEN" => ("WICHITA_FALLS_COGEN_CC6", "WICHITA_FALLS_COGEN_CC8", "WICHITA_FALLS_COGEN_CC9"),
"PANDA_SHERMAN" => ("PANDA_SHERMAN_CC1", "PANDA_SHERMAN_CC2", "PANDA_SHERMAN_CC3"),
"LAMAR_ENERGY_CENTER1" => ("LAMAR_ENERGY_CENTER1_CC1", "LAMAR_ENERGY_CENTER1_CC2", "LAMAR_ENERGY_CENTER1_CC4"),
"LAMAR_ENERGY_CENTER2" => ("LAMAR_ENERGY_CENTER2_CC1", "LAMAR_ENERGY_CENTER2_CC2", "LAMAR_ENERGY_CENTER2_CC4"),
"INGLESIDE" => ("INGLESIDE_CC1", "INGLESIDE_CC2", "INGLESIDE_CC3", "INGLESIDE_CC4", "INGLESIDE_CC5", "INGLESIDE_CC6"),
"HIDALGO_ENERGY_CENTER" => ("HIDALGO_ENERGY_CENTER_CC1", "HIDALGO_ENERGY_CENTER_CC2", "HIDALGO_ENERGY_CENTER_CC3"),
...
"FORNEY_ENERGY_CENTER1" => ("FORNEY_ENERGY_CENTER1_CC1", "FORNEY_ENERGY_CENTER1_CC2", "FORNEY_ENERGY_CENTER1_CC3"),
"FORNEY_ENERGY_CENTER2" => ("FORNEY_ENERGY_CENTER2_CC1", "FORNEY_ENERGY_CENTER2_CC2", "FORNEY_ENERGY_CENTER2_CC3"),
"WISE_TRACTEBEL_POWER" => ("WISE_TRACTEBEL_POWER_CC1", "WISE_TRACTEBEL_POWER_CC2", "WISE_TRACTEBEL_POWER_CC3"),
"PANDA_TEMPLE_I" => ("PANDA_TEMPLE_I_CC1", "PANDA_TEMPLE_I_CC2", "PANDA_TEMPLE_I_CC3"),
...
"JACK_COUNTY_GEN_FACILITY_1" => ("JACK_COUNTY_GEN_FACILITY_1_CC1", "JACK_COUNTY_GEN_FACILITY_1_CC2", "JACK_COUNTY_GEN_FACILITY_1_CC3"),
"JACK_COUNTY_GEN_FACILITY_2" => ("JACK_COUNTY_GEN_FACILITY_2_CC1", "JACK_COUNTY_GEN_FACILITY_2_CC2", "JACK_COUNTY_GEN_FACILITY_2_CC3"),
...
"GUADALUPE_ENERGY_CENTER1" => ("GUADALUPE_ENERGY_CENTER1_CC1", "GUADALUPE_ENERGY_CENTER1_CC3", "GUADALUPE_ENERGY_CENTER1_CC4"),
"GUADALUPE_ENERGY_CENTER2" => ("GUADALUPE_ENERGY_CENTER2_CC1", "GUADALUPE_ENERGY_CENTER2_CC2", "GUADALUPE_ENERGY_CENTER2_CC4"),
"RIO_NOGALES_POWER" => ("RIO_NOGALES_POWER_CC1", "RIO_NOGALES_POWER_CC2", "RIO_NOGALES_POWER_CC3", "RIO_NOGALES_POWER_CC4"),
"ARTHUR_VON_ROSENBERG" => ("ARTHUR_VON_ROSENBERG_CC1", "ARTHUR_VON_ROSENBERG_CC2"),
"SANDHILL_ENERGY_CENTER" => ("SANDHILL_ENERGY_CENTER_CC1", "SANDHILL_ENERGY_CENTER_CC2", "SANDHILL_ENERGY_CENTER_CC3"),
"BASTROP_ENERGY_CENTER" => ("BASTROP_ENERGY_CENTER_CC1", "BASTROP_ENERGY_CENTER_CC2", "BASTROP_ENERGY_CENTER_CC3"),
"CHANNEL_ENERGY_CENTER1" => ("CHANNEL_ENERGY_CENTER1_CC1", "CHANNEL_ENERGY_CENTER1_CC2"),
"CHANNEL_ENERGY_CENTER2" => ("CHANNEL_ENERGY_CENTER2_CC1", "CHANNEL_ENERGY_CENTER2_CC3", "CHANNEL_ENERGY_CENTER2_CC4"),
...
"DEER_PARK_ENERGY_CENTER" => ("DEER_PARK_ENERGY_CENTER_CC1", "DEER_PARK_ENERGY_CENTER_CC2", "DEER_PARK_ENERGY_CENTER_CC4", "DEER_PARK_ENERGY_CENTER_CC5", "DEER_PARK_ENERGY_CENTER_CC6"),
"TH_WARTON1" => ("TH_WARTON1_CC2", "TH_WARTON1_CC3", "TH_WARTON1_CC4", "TH_WARTON1_CC7", "TH_WARTON1_CC8"),
"TH_WARTON2" => ("TH_WARTON2_CC2", "TH_WARTON2_CC4", "TH_WARTON2_CC7", "TH_WARTON2_CC8"),
"CEDAR_BAYOU" => ("CEDAR_BAYOU_CC1", "CEDAR_BAYOU_CC2", "CEDAR_BAYOU_CC4"),
"TEXAS_CITY_POWER" => ("TEXAS_CITY_POWER_CC9", "TEXAS_CITY_POWER_CC1", "TEXAS_CITY_POWER_CC3", "TEXAS_CITY_POWER_CC6", "TEXAS_CITY_POWER_CC7"),
"COLORADO_BEND_ENERGY_CENTER_1" => ("COLORADO_BEND_ENERGY_CENTER_1_CC2", ),
"COLORADO_BEND_ENERGY_CENTER_2" => ("COLORADO_BEND_ENERGY_CENTER_2_CC1", "COLORADO_BEND_ENERGY_CENTER_2_CC2"),
"COLORADO_BEND_ENERGY_CENTER_3" => ("COLORADO_BEND_ENERGY_CENTER_3_CC1", "COLORADO_BEND_ENERGY_CENTER_3_CC2"),
"PASADENA_COGENERATION" => ("PASADENA_COGENERATION_CC1", "PASADENA_COGENERATION_CC2"),
"BRAZOS_VALLEY" => ("BRAZOS_VALLEY_CC1", "BRAZOS_VALLEY_CC2", "BRAZOS_VALLEY_CC3", "BRAZOS_VALLEY_CC4"),
"POWER_SYSTEMS_ARCO_COGEN1" => ("POWER_SYSTEMS_ARCO_COGEN1_CC1", "POWER_SYSTEMS_ARCO_COGEN1_CC2"),
"POWER_SYSTEMS_ARCO_COGEN2" => ("POWER_SYSTEMS_ARCO_COGEN2_CC1", "POWER_SYSTEMS_ARCO_COGEN2_CC2"),
"POWER_SYSTEMS_ARCO_COGEN3" => ("POWER_SYSTEMS_ARCO_COGEN3_CC1", "POWER_SYSTEMS_ARCO_COGEN3_CC2"),
"CHANNELVIEW_COGENERATION_PLANT" => ("CHANNELVIEW_COGENERATION_PLANT_CC1", "CHANNELVIEW_COGENERATION_PLANT_CC2", "CHANNELVIEW_COGENERATION_PLANT_CC5", "CHANNELVIEW_COGENERATION_PLANT_CC6"),
"GREENS_BAYOU" => ("GREENS_BAYOU_CC2", "GREENS_BAYOU_CC3"),
"TENASKA_FRONTIER_STATION" => ("TENASKA_FRONTIER_STATION_CC1", "TENASKA_FRONTIER_STATION_CC4", "TENASKA_FRONTIER_STATION_CC9", "TENASKA_FRONTIER_STATION_CC12"),
"FREESTONE_ENERGY_CENTER1" => ("FREESTONE_ENERGY_CENTER1_CC1", "FREESTONE_ENERGY_CENTER1_CC2", "FREESTONE_ENERGY_CENTER1_CC3"),
"FREESTONE_ENERGY_CENTER2" => ("FREESTONE_ENERGY_CENTER2_CC1", "FREESTONE_ENERGY_CENTER2_CC2", "FREESTONE_ENERGY_CENTER2_CC3"),
"TENASKA_GATEWAY_STATION" => ("TENASKA_GATEWAY_STATION_CC1", "TENASKA_GATEWAY_STATION_CC2", "TENASKA_GATEWAY_STATION_CC3", "TENASKA_GATEWAY_STATION_CC4")
)
