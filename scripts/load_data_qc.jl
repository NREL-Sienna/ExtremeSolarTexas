...
actuals_file =
    h5open("/Users/jdlara/cache/blue_texas/input_data/load/5-minute_load_actuals.h5")
da_load_forecast =
    h5open("/Users/jdlara/cache/blue_texas/input_data/load/day_ahead_load_forecast.h5")
rt_load_forecast =
    h5open("/Users/jdlara/cache/blue_texas/input_data/load/intra-hourly_load_forecast.h5")

da_load_forecast_perfect = h5open(
    "/Users/jdlara/cache/blue_texas/input_data/load/day_ahead_perfect_load_forecast.h5",
)
rt_load_forecast_perfect = h5open(
    "/Users/jdlara/cache/blue_texas/input_data/load/intra-hourly_perfect_load_forecast.h5",
)
...
base_line_tl =
    range(DateTime("2018-01-01T00:00:00"), step = Minute(5), length = 365 * 24 * 12)
...
actual_trace =
    scatter(; x = time_stamp_actuals, y = actual, model = "Line", name = "Actual")
plot(actual_trace)
...
da_trace =
    scatter(; x = time_stamp_da, y = da, name = "DA", mode = "lines", line_shape = "hv")
plot(da_trace)
